...
CORPUS_SCHEMA = "copperwright-error-corpus"
CORPUS_VERSION = 1
BENCHMARK_SCHEMA = "copperwright-benchmark-result"
BENCHMARK_VERSION = 1
CORPUS_LIMIT = 8 * 1024 * 1024
BUNDLED_REQUIREMENTS_LOCATOR = (
    "src/copperwright/data/benchmark/acceptance_requirements.json"
)
...
def _run_model_benchmark(
    ...
    *,
    ...
    for index in range(runs):
        ...
        except (CopperWrightError, ValidationError, OSError) as exc:
            failures.append(
                {
                    "run": index + 1,
