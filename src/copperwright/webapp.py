...
class CopperWrightHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        except (CopperWrightError, ValueError) as exc:
    ...
    def _serve_static(self, path: str) -> None:
        ...
        resource = files("copperwright").joinpath("web", resource_name)
    ...
    def _open_kicad(self, project_id: str) -> None:
        ...
        if not executable:
            raise CopperWrightError("KiCad desktop application is unavailable")
        ...
        try:
            ...
            raise CopperWrightError(
                "failed to start KiCad desktop application"
            ) from exc
