...
WORKER_PHASE_ALLOWLIST = frozenset(
    {
        ...
        "inspect_board_tracks_container_end",
        "inspect_board_tracks_iterator_next",
        "inspect_board_tracks_type_classification",
        "inspect_board_tracks_via_top_layer",
        "inspect_board_tracks_via_bottom_layer",
        "inspect_board_tracks_net_name",
        "inspect_board_tracks_numeric_geometry",
        "inspect_board_tracks_segment_layer",
        "inspect_board_tracks_item_markers_suppressed",
        "inspect_board_tracks_complete",
        "inspect_board_zones",
