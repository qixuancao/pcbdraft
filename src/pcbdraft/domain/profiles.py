...
def safe_design_id(name: str) -> str:
    ...
    if not value or not value[0].isalpha():
        value = "pcbdraft_board"
    return value[:64].rstrip("_") or "pcbdraft_board"
...
def build_requirements(
    ...
    *,
    ...
    value: dict[str, Any] = {
        ...
        "source": {
            "name": "confirmed PCBDraft conversation",
