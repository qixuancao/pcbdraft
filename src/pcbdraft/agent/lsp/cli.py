...
def _cmd_status(emit_json: bool) -> int:
    ...
    from pcbdraft.agent.lsp.install import detect_status
...
def _cmd_install(server_id: str) -> int:
    from pcbdraft.agent.lsp.install import INSTALL_RECIPES, detect_status, try_install
...
def _cmd_restart() -> int:
    from pcbdraft.agent.lsp import shutdown_service
...
def _cmd_which(server_id: str) -> int:
    from pcbdraft.agent.lsp.install import INSTALL_RECIPES, _existing_binary
...
def _backend_warnings() -> list:
    ...
    from pcbdraft.agent.lsp.install import _existing_binary
