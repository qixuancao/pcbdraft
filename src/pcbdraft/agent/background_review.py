...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with PCBDraft).\n"
    "  • Hub-installed skills (installed through the skill hub).\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked by the curator). You are an "
    ...
    "manual adoption in the curator settings — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed through the skill hub).\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked by the curator). Pin blocks "
    ...
    "reply and recommend manual adoption in the curator settings instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            if not _routed:
                _fork_kwargs["reasoning_config"] = getattr(
