...
from pcbdraft.agent.context_engine import (
...
from pcbdraft.model.auxiliary_client import AuxiliaryExplicitCancellation
...
def _cached_prompt_reflects_builtin_memory(agent: Any, cached_prompt: str) -> bool:
    ...
    if snapshot is None:
        return False
    try:
        from pcbdraft.tools.memory_tool import MEMORY_BLOCK_HEADERS
    except Exception:
        return False
...
def _adopt_live_compression_child(
    ...
    try:
        ...
        os.environ["PCBDRAFT_RUNTIME_SESSION_ID"] = child_session_id
    try:
    ...
    *after* construction, so :func:`replay_compression_warning` re-sends
    ...
    try:
        ...
        if aux_context < threshold:
            ...
            from pcbdraft.agent.context_compressor import ContextCompressor as _CC
...
def _strip_stale_todo_snapshot(content: Any) -> Any:
    ...
    """
    from pcbdraft.tools.todo_tool import TODO_INJECTION_HEADER
...
def compress_context(
    ...
    *,
    ...
    _commit_watermark: int | None = None
    ...
    _lock_lookup_error: Exception | None = None
    ...
    _lock_refresher: _CompressionLockLeaseRefresher | None = None
    ...
    try:
        ...
        if todo_snapshot:
            ...
            from pcbdraft.agent.context_compressor import _append_text_to_content
        ...
        if agent._session_db:
            ...
            try:
                ...
                if in_place:
                    ...
                    # whose thread lacks the PCBDRAFT_RUNTIME_HOME context.
                    try:
                    ...
                    agent._session_db.publish_compression_child(
                        ...
                        or os.environ.get("PCBDRAFT_RUNTIME_SESSION_SOURCE", "cli"),
                        model=agent.model,
                    ...
                    try:
                        from pcbdraft.interfaces.tui.heartbeat import (
                    ...
                    # survive compression.
                    try:
                        from pcbdraft.interfaces.tui.loops import (
                        ...
                        logger.debug(
                            "Could not migrate loop on compression: %s", _loop_err
                        )
        ...
        try:
            from pcbdraft.tools.file_tools import reset_file_dedup
        ...
        try:
            from pcbdraft.tools.skills_tool import reset_skill_view_dedup
...
def _compress_context_via_codex_app_server(
    ...
    *,
    ...
    try:
        from pcbdraft.model.codex_runtime import (
...
def try_shrink_image_parts_in_messages(
    ...
    *,
    ...
    try:
        from pcbdraft.tools.vision_tools import _resize_image_for_vision
    except Exception as exc:
