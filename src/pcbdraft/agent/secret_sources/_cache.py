...
from pcbdraft.agent.secret_sources.base import FetchResult, is_valid_env_name
...
class DiskCache(Generic[K]):
    ...
    One JSON object per backend lives at ``<runtime_home>/cache/<basename>``::
    ...
    def write(
        ...
        try:
            ...
            # metadata isn't exposed if PCBDRAFT_RUNTIME_HOME is ever made traversable.
            try:
