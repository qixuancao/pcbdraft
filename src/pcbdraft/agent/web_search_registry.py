...
def register_provider(provider: WebSearchProvider, *, scope: str | None = None) -> None:
...
def get_provider(name: str, *, scope: str | None = None) -> WebSearchProvider | None:
...
def _disabled_web_plugin_for(
    configured: str | None = None, *, capability: str | None = None
) -> str | None:
