...
from pcbdraft.agent.memory_manager import build_memory_context_block
...
def _maybe_title_session_at_turn_start(agent: Any, messages: list[Any]) -> None:
    ...
    try:
        ...
        from pcbdraft.agent.title_generator import maybe_auto_title
...
def build_turn_context(
    ...
    *,
    ...
    try:
        ...
        from pcbdraft.model.auxiliary_client import set_runtime_main
    ...
    from pcbdraft.agent.agent_runtime_helpers import note_turn_start
    ...
    if reaction_callback is not None:
        try:
            from pcbdraft.agent.reactions import detect_reaction
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        if _should_compress_now:
            ...
            for _pass in range(_max_preflight_passes):
                ...
                if messages is _preflight_input and compression_skipped_due_to_lock(
                    agent
                ):
    ...
    try:
        ...
        try:
            from pcbdraft.tools.hook_output_spill import get_spill_config as _spill_cfg
            from pcbdraft.tools.hook_output_spill import (
