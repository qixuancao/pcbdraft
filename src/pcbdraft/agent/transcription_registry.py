...
def register_provider(
    provider: TranscriptionProvider, *, scope: str | None = None
) -> None:
...
def list_providers(*, scope: str | None = None) -> list[TranscriptionProvider]:
...
def restore_registration(
    ...
    previous: TranscriptionProvider | None,
    *,
    scope: str | None = None,
) -> bool:
