...
def _images_cache_dir() -> Path:
    """Return ``$PCBDRAFT_RUNTIME_HOME/cache/images/``, creating parents as needed."""
    from pcbdraft.core.runtime_environment import get_runtime_home

    path = get_runtime_home() / "cache" / "images"
...
def save_b64_image(
    ...
    *,
    ...
    """Decode base64 image data and write it under ``$PCBDRAFT_RUNTIME_HOME/cache/images/``.
...
def save_url_image(
    ...
    *,
    ...
    """Download an image URL and write it under ``$PCBDRAFT_RUNTIME_HOME/cache/images/``.
