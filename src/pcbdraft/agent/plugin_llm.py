...
def _resolve_task_ownership(plugin_id: str) -> tuple[frozenset, frozenset]:
    ...
    try:
        ...
        pass
    try:
        from pcbdraft.interfaces.tui.main import _AUX_TASKS
...
def _resolve_attribution(
    *,
    ...
    if route_provider:
        ...
        try:
            from pcbdraft.model.auxiliary_client import _read_main_provider
    ...
    if isinstance(response_model, str) and response_model.strip():
        ...
        try:
            from pcbdraft.model.auxiliary_client import _read_main_model
...
class PluginLlm:
    ...
    def _invoke_sync(
        ...
        *,
        ...
        route_info: dict[str, str] | None = {} if task else None
        response = call_llm(
            task=task,
            provider=provider_override,
            model=model_override,
    ...
    async def _invoke_async(
        ...
        *,
        ...
        from pcbdraft.model.auxiliary_client import async_call_llm
