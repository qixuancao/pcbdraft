...
def derive_title(user_message: str) -> str | None:
...
def auto_title_session(
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running PCBDraft process): %s",
            e,
        )
...
def _auto_title_session(
    ...
    from pcbdraft.agent.portal_tags import set_conversation_context
    from pcbdraft.model.aux_accounting import set_accounting_context
