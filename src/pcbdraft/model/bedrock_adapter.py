...
def convert_messages_to_converse(
    ...
    if converse_msgs and converse_msgs[0]["role"] != "user":
        converse_msgs.insert(
            0, {"role": "user", "content": [{"text": _EMPTY_TEXT_PLACEHOLDER}]}
        )
...
def probe_bedrock_context_length(model_id: str, region: str) -> int | None:
    ...
    """
    try:
        from pcbdraft.model.model_metadata import parse_context_limit_from_error
