...
def _prune_env_pool_entries(env_var: str) -> list[str]:
    ...
    """
    from pcbdraft.model.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def _scrub_config_yaml_mirrors(old_value: str, new_value: str | None) -> list[str]:
    ...
    if not old_value:
        return []
    from pcbdraft.core.runtime_utils import atomic_yaml_write, fast_safe_load
...
def save_provider_env_credential(env_var: str, value: str) -> dict[str, Any]:
    ...
    """
    from pcbdraft.model.configuration import load_env, save_env_value
    ...
    # that reads this var.
    try:
        from pcbdraft.model.auth import unsuppress_credential_source
...
def remove_provider_env_credential(env_var: str) -> dict[str, Any]:
    ...
    """
    from pcbdraft.model.configuration import load_env, remove_env_value
