...
from pcbdraft.agent.bounded_response import read_streaming_error_body
from pcbdraft.model.gemini_schema import sanitize_gemini_tool_parameters
...
def gemini_http_error(
    response: httpx.Response, *, body_text: str | None = None
) -> GeminiAPIError:
