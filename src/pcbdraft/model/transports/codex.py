...
from pcbdraft.model.transports.types import NormalizedResponse, ToolCall
...
def _xai_prefers_native_web_search() -> bool:
    ...
    """
    try:
        from pcbdraft.agent.web_search_registry import get_active_search_provider

        provider = get_active_search_provider()
        if provider is not None:
            return getattr(provider, "name", None) == "xai"

        from pcbdraft.tools.web_tools import _get_search_backend
...
def _default_prompt_cache_retention_for_request(
    ...
    from pcbdraft.core.runtime_utils import base_url_hostname
...
def _is_post_tool_replay(messages: list[dict[str, Any]] | None) -> bool:
    ...
    payload through.
    """
    from pcbdraft.model.codex_responses_adapter import _split_responses_tool_id
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def _resolve_issuer_kind(self, params: dict[str, Any]) -> str:
        ...
        from pcbdraft.model.codex_responses_adapter import _classify_responses_issuer
    ...
    def convert_tools(self, tools: list[dict[str, Any]]) -> Any:
        ...
        from pcbdraft.model.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        **params,
        ...
        """
        from pcbdraft.agent.loop import DEFAULT_AGENT_IDENTITY
        from pcbdraft.model.codex_responses_adapter import (
            _chat_messages_to_responses_input,
            _responses_tools,
        )
        ...
        cache_key = (
            _content_cache_key(instructions, response_tools, _cache_scope)
            or _cache_scope
        )
        ...
        if reasoning_enabled and is_xai_responses:
            from pcbdraft.model.model_metadata import grok_supports_reasoning_effort
        ...
        if is_xai_responses:
            ...
            if not (
                is_grok_46_family(model) and kwargs.get("service_tier") == "priority"
            ):
        ...
        if is_codex_backend:
            ...
            final_cache_key = kwargs.get(
                "prompt_cache_key"
            ) or _bounded_prompt_cache_key(_cache_scope)
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        from pcbdraft.model.codex_responses_adapter import _normalize_codex_response
    ...
    def preflight_kwargs(
        ...
        *,
        ...
        """
        from pcbdraft.model.codex_responses_adapter import _preflight_codex_api_kwargs
