...
Run with: python -m agent.transports.tools_mcp_server
...
EXPOSED_TOOLS: tuple[str, ...] = (
    ...
    "skills_list",
    "text_to_speech",
    # Kanban worker handoff tools — gated on PCBDRAFT_RUNTIME_KANBAN_TASK env var
    ...
    # only — the kanban tool gates them on PCBDRAFT_RUNTIME_KANBAN_TASK being unset.
...
def main(argv: list[str] | None = None) -> int:
    """Entry point for `python -m agent.transports.tools_mcp_server`."""
    ...
    os.environ.setdefault("PCBDRAFT_RUNTIME_QUIET", "1")
    os.environ.setdefault("PCBDRAFT_RUNTIME_REDACT_SECRETS", "true")
