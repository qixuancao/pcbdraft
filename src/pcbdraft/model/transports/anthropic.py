...
class AnthropicTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: list[dict[str, Any]], **kwargs) -> Any:
        ...
        """
        from pcbdraft.model.anthropic_adapter import convert_messages_to_anthropic
    ...
    def convert_tools(self, tools: list[dict[str, Any]]) -> Any:
        ...
        from pcbdraft.model.anthropic_adapter import convert_tools_to_anthropic
    ...
    def build_kwargs(
        ...
        **params,
        ...
        """
        from pcbdraft.model.anthropic_adapter import build_anthropic_kwargs
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        from pcbdraft.model.transports.types import ToolCall
        ...
        for block in response.content:
            ...
            if block.type == "text":
                ...
                if strip_tool_prefix and name.startswith(_MCP_PREFIX):
                    ...
                    from pcbdraft.tools.registry import registry as _tool_registry
