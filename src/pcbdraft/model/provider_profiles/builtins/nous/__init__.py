...
from pcbdraft.agent.portal_tags import get_conversation_context, nous_portal_tags
...
from pcbdraft.model.transports.codex import _cache_scope_from_session_id
