...
from pcbdraft.core.project import (
    baseline_manifest,
    canonical_project,
    copy_project,
    discover_project,
...
from pcbdraft.verification.report import render_review_markdown
from pcbdraft.verification.semantic import collect_semantic_context
