...
from pcbdraft.model.configuration import cfg_get, load_config, read_raw_config
from pcbdraft.tools.browser_camofox_state import get_camofox_identity
...
_cached_cmd_timeout: int | None = None
...
def _camofox_identity_override(
    task_id: str | None, camofox_cfg: dict[str, Any]
) -> dict[str, str] | None:
...
def _camofox_private_page_block(
    session: dict[str, Any], task_id: str | None, action: str
) -> str | None:
...
def camofox_type(ref: str, text: str, task_id: str | None = None) -> str:
    ...
    try:
        ...
        from pcbdraft.agent.display import redact_browser_typed_text_for_display
...
def camofox_vision(
    question: str, annotate: bool = False, task_id: str | None = None
) -> str:
    ...
    try:
        ...
        screenshots_dir = get_runtime_home() / "browser_screenshots"
