...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "PCBDraft (https://github.com/qixuancao/pcbdraft)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_runtime_home() / "cache" / "discord_capabilities.json"
...
def _load_caps_from_disk(token: str) -> dict[str, Any] | None:
