...
Pending records live under ``<PCBDRAFT_RUNTIME_HOME>/pending/{memory,skills}/<id>.json``
...
def _pending_dir(subsystem: str) -> Path:
    return get_runtime_home() / "pending" / subsystem
...
def current_origin() -> str:
    ...
    """
    try:
        from pcbdraft.tools.skill_provenance import get_current_write_origin
