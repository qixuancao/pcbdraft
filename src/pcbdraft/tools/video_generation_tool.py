...
def _handle_video_generate(args: dict[str, Any], **_kw: Any) -> str:
    ...
    from pcbdraft.tools.image_generation_tool import _confine_source_images
...
def _build_dynamic_video_schema() -> dict[str, Any]:
    ...
    if min_duration and max_duration:
        parts.append(f"- duration range: {min_duration}-{max_duration}s")
    ...
    if provider.name == "xai":
        ...
        try:
            from pcbdraft.tools.xai_http import xai_storage_notice_text
