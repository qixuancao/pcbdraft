...
CORPUS_VERSION = 1
BENCHMARK_SCHEMA = "pcbdraft-benchmark-result"
BENCHMARK_VERSION = 1
CORPUS_LIMIT = 8 * 1024 * 1024
BUNDLED_REQUIREMENTS_LOCATOR = (
    "src/pcbdraft/data/benchmark/acceptance_requirements.json"
)
...
def bundled_corpus_path() -> Path:
    return data_path("benchmark", "error_corpus.json")


def bundled_requirements_path() -> Path:
    return data_path("benchmark", "acceptance_requirements.json")
...
def run_benchmark(
    ...
    *,
    ...
    result = {
        ...
        "engine": {
            "name": "PCBDraft deterministic semantic intent registry",
            "version": 1,
        ...
        "base_fixture": {
            "requirements": BUNDLED_REQUIREMENTS_LOCATOR,
