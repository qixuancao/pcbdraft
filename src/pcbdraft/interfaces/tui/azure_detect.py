...
def _apply_auth_headers(
    req: urllib_request.Request, token: str | None, mode: str
) -> None:
...
def _http_get_json(
    ...
    *,
    ...
    req.add_header("User-Agent", "pcbdraft/azure-detect")
    try:
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            return bool(
                exc.code == 400 and ("messages" in lowered or "model" in lowered)
            )
        except Exception:
            return False
