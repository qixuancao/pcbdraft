...
from pcbdraft.core.runtime_environment import get_optional_mcps_dir, get_runtime_home
from pcbdraft.interfaces.tui._subprocess_compat import noninteractive_git_env
from pcbdraft.interfaces.tui.cli_output import prompt as _prompt_input
...
def _parse_manifest(path: Path) -> CatalogEntry:
    ...
    if t_type == "http" and a_type == "api_key":
        ...
        # at connect time.
        from pcbdraft.interfaces.tui.mcp_config import _env_key_for_server
...
def _install_root() -> Path:
    ...
    root = get_runtime_home() / "mcp-installs"
...
def _build_server_config(entry: CatalogEntry, install_dir: Path | None) -> dict:
    ...
    if t.type == "stdio":
        ...
        if entry.auth.type == "oauth":
            ...
            from pcbdraft.interfaces.tui.mcp_config import _bearer_auth_headers
...
def install_entry(entry: CatalogEntry, *, enable: bool = True) -> None:
    ...
    from pcbdraft.interfaces.tui.mcp_config import _save_mcp_server
