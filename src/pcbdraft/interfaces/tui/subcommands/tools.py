"""``internal tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'pcbdraft --help' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # internal tools list [--platform cli]
    ...
    # internal tools disable <name...> [--platform cli]
    ...
    # internal tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `pcbdraft --help` runs after you pick a provider that\n"
