...
def build_dashboard_parser(
    ...
    # (cmd_dashboard exports PCBDRAFT_RUNTIME_SERVE_HEADLESS=1). `dashboard` leaves it
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        ...
        description=(
            ...
            "PCBDRAFT_RUNTIME_DASHBOARD_OAUTH_CLIENT_ID into ~/.hermes/.env, and prints "
    ...
    dashboard_register_parser.add_argument(
        ...
        help=(
            ...
            "portal. Also settable via PCBDRAFT_RUNTIME_DASHBOARD_PORTAL_URL. Mainly for "
