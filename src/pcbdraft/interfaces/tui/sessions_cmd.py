...
def _prune_never_active_keyed(db, args):
    ...
    """
    from pcbdraft.interfaces.tui.session_filters import (
        format_epoch,
...
def cmd_sessions(args, sessions_parser=None):
    ...
    if action == "recover":
        ...
        from pcbdraft.interfaces.tui.session_recovery import (
    ...
    if action == "import":
        from pcbdraft.interfaces.tui.foreign_sessions import run_sessions_import
    ...
    if action == "list":
        from pcbdraft.services.session_db import workspace_key as _ws_key
        ...
        if args.format == "trace":
            ...
            from pcbdraft.agent.trace_upload import (
                TraceRedactionError,
                build_trace_jsonl,
            ...
            try:
                if len(ids) == 1:
                    ...
                    out_dir = (
                        ...
                        else get_runtime_home() / "session-exports"
                    )
        ...
        # Markdown / QMD export
        from pcbdraft.interfaces.tui.session_export_md import (
        ...
        from pcbdraft.agent.title_generator import generate_title
