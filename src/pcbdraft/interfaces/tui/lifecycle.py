"""PCBDraft lifecycle dispatch for first-party observers and plugins."""
...
def invoke_hook(hook_name: str, **kwargs: Any) -> list[Any]:
    ...
    try:
        from pcbdraft.interfaces.tui.observability import observe_lifecycle
...
def has_hook(hook_name: str) -> bool:
    ...
    try:
        from pcbdraft.interfaces.tui.observability import handles_hook
