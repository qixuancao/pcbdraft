...
key tuples PCBDraft already binds.
...
def install_shift_enter_alias() -> int:
    ...
    at the application layer — the sequences above never reach PCBDraft.
