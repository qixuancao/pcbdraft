...
async def list_skills_hub_sources(profile: str | None = None):
    ...
    def _run():
        from pcbdraft.tools.skills_hub import create_source_router
...
async def preview_skill_hub(identifier: str = "", profile: str | None = None):
    ...
    def _run():
        from pcbdraft.interfaces.tui.skills_hub import _resolve_source_meta_and_bundle
        from pcbdraft.tools.skills_hub import create_source_router
...
async def scan_skill_hub(identifier: str = "", profile: str | None = None):
    ...
    def _run():
        ...
        from pcbdraft.interfaces.tui.skills_hub import _resolve_source_meta_and_bundle
        from pcbdraft.tools.skills_guard import scan_skill, should_allow_install
        from pcbdraft.tools.skills_hub import create_source_router, quarantine_bundle
...
async def get_skills(profile: str | None = None):
    from pcbdraft.interfaces.tui.skills_config import get_disabled_skills
...
async def get_skill_content(name: str, profile: str | None = None):
    ...
    from pcbdraft.tools.skill_manager_tool import _find_skill
...
async def create_skill(body: SkillCreate):
    ...
    """
    from pcbdraft.tools.skill_manager_tool import _create_skill
...
async def update_skill_content(body: SkillContentUpdate):
    ...
    from pcbdraft.tools.skill_manager_tool import _edit_skill
