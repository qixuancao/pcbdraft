"""Shared curses-based UI components for PCBDraft CLI.

Used by `internal tools` and `internal skills` for interactive checklists.
...
def _curses_style_attr(curses, style: str | None, *, is_cursor: bool):
...
def _draw_radio_item(
    stdscr, y: int, x: int, item: RadioItem, max_x: int, *, is_cursor: bool
) -> None:
