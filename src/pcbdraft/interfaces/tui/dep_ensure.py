...
_DEP_CHECKS = {
    # find_node_executable() rather than a bare which(): $PCBDRAFT_RUNTIME_HOME/node is
...
def _has_hermes_agent_browser() -> bool:
    ...
    # install.sh installs globally into $PCBDRAFT_RUNTIME_HOME/node/bin/ via npm -g --prefix
