...
from pcbdraft.interfaces.tui.dashboard_auth.login_page import render_login_html
...
def _redirect_uri(request: Request) -> str:
    ...
    Three resolution tiers:
      ...
      1. ``PCBDRAFT_RUNTIME_DASHBOARD_PUBLIC_URL`` env var or
...
async def auth_native_authorize(
    ...
    from pcbdraft.interfaces.tui.dashboard_auth import native_flow
...
async def auth_native_refresh(request: Request, body: _NativeRefreshBody):
    ...
    from pcbdraft.interfaces.tui.dashboard_auth.base import RefreshExpiredError
