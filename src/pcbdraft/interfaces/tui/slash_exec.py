...
def _exec_version(ctx: CommandContext) -> CommandReply:
    ...
    from pcbdraft.interfaces.tui.banner import format_banner_version_label
...
def _exec_profile(ctx: CommandContext) -> CommandReply:
    ...
    if not home_display:
        ...
        home_display = display_runtime_home()
...
def _exec_bundles(ctx: CommandContext) -> CommandReply:
    ...
    try:
        from pcbdraft.agent.skill_bundles import _bundles_dir, list_bundles
...
def _exec_help(ctx: CommandContext) -> CommandReply:
    ...
    from pcbdraft.interfaces.tui.commands import gateway_help_lines
    ...
    try:
        from pcbdraft.agent.skill_commands import get_skill_commands
