...
from pcbdraft.interfaces.tui.mcp_catalog import (
    CatalogEntry,
    CatalogError,
    catalog_diagnostics,
    install_entry,
...
def _configure_tools(name: str) -> None:
    ...
    from pcbdraft.interfaces.tui.mcp_config import cmd_mcp_configure
...
def install_by_name(identifier: str) -> int:
    ...
    exit codes).
    """
    from pcbdraft.interfaces.tui.mcp_catalog import get_entry
