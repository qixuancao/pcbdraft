...
Entry point: ``internal whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``pcbdraft.interfaces.tui/main.py``).
...
PCBDraft gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures PCBDraft to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  PCBDraft needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the PCBDraft gateway in another terminal:")
    print("         pcbdraft --help")
    print()
