...
Sibling of ``pcbdraft.interfaces.tui.timefmt`` (same extraction rationale: a tiny
...
* ``pcbdraft.interfaces.tui/session_recovery.py`` uses binary suffixes (KiB/MiB/GiB)
