...
from pcbdraft.model.configuration import get_env_value, load_config
...
def _has_agent_browser() -> bool:
    ...
    from pcbdraft.core.runtime_environment import agent_browser_runnable
...
def _local_stt_backend_available() -> bool:
    ...
    """
    if get_env_value("PCBDRAFT_RUNTIME_LOCAL_STT_COMMAND"):
        return True
    try:
        from pcbdraft.tools.transcription_tools import _HAS_FASTER_WHISPER
    ...
    *,
    ...
    try:
        ...
        local_stt_available = bool(_HAS_FASTER_WHISPER) or bool(
            get_env_value("PCBDRAFT_RUNTIME_LOCAL_STT_COMMAND")
        )
    except Exception:
        local_stt_available = bool(get_env_value("PCBDRAFT_RUNTIME_LOCAL_STT_COMMAND"))
...
def prompt_enable_tool_gateway(
    ...
    *,
    ...
    try:
        from pcbdraft.interfaces.tui.setup import prompt_checklist
    except Exception:
        return set()
