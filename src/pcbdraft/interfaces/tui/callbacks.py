...
into prompt_toolkit's event loop. Each function takes the TerminalApp instance
...
from pcbdraft.interfaces.tui.banner import _DIM, _RST, cprint
from pcbdraft.interfaces.tui.secret_prompt import masked_secret_prompt
from pcbdraft.model.configuration import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.pcbdraft/.env and never exposed to the model.
    """
