...
class CLIAgentSetupMixin:
    """Agent construction + session-resume display methods for ``TerminalApp``."""
    ...
    def _ensure_runtime_credentials(self) -> bool:
        ...
        if not self.model and resolved_provider:
            try:
                from pcbdraft.model.catalog import get_default_model_for_provider
    ...
    def _offer_first_run_setup(self) -> bool:
        ...
        _cprint(
            "  You'll pick a provider (Nous Portal OAuth is the fastest; "
    ...
    def _resolve_turn_agent_config(self, user_message: str) -> dict:
        ...
        """
        from pcbdraft.model.catalog import resolve_fast_mode_overrides
        ...
        *,
        ...
        if self._resumed and self._session_db and not self.conversation_history:
            ...
            if resume_limit_error:
                ...
                if _quiet_mode:
                    print(
                        f"Cannot resume session: {resume_limit_error}", file=sys.stderr
                    )
                else:
                    ChatConsole().print(
        ...
        try:
            ...
            from pcbdraft.core.runtime_environment import partial_update_hint
    ...
    def _display_resumed_history(self):
        ...
        from pcbdraft.tools.ansi_strip import (
            sanitize_display_text as _sanitize_display_text,
        )

        display_history = getattr(
