...
- ``default`` — PCBDraft gold/kawaii (the current look)
...
class SkinConfig:
    ...
    banner_logo: str = (
        ""  # Rich-markup ASCII art logo (replaces PCBDRAFT_RUNTIME_AGENT_LOGO)
    )
    banner_hero: str = ""  # Rich-markup hero art (replaces PCBDRAFT_RUNTIME_CADUCEUS)
...
def _build_skin_config(data: dict[str, Any]) -> SkinConfig:
    ...
    light_colors = _mapping_or_empty(
        data.get("light_colors"), section="light_colors", skin_name=skin_name
    )
    dark_colors = _mapping_or_empty(
        data.get("dark_colors"), section="dark_colors", skin_name=skin_name
    )
