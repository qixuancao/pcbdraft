...
# argparse runs (it sets ``PCBDRAFT_RUNTIME_HOME`` and strips itself from ``sys.argv``),
...
def build_top_level_parser():
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "Applies to -z/--oneshot and --tui. Also settable via PCBDRAFT_RUNTIME_INFERENCE_MODEL env var."
        ),
    )
    _inherited_flag(
        parser,
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "without a TTY prompt.  Equivalent to PCBDRAFT_RUNTIME_ACCEPT_HOOKS=1 or "
    ...
    _inherited_flag(
        ...
        help=(
            "Auto-approve any unseen shell hooks declared in config.yaml "
            "without a TTY prompt (see also PCBDRAFT_RUNTIME_ACCEPT_HOOKS env var and "
