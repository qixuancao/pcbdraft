"""First-party PCBDraft observability integrations."""
...
def observe_lifecycle(hook_name: str, **kwargs: Any) -> None:
    """Dispatch a PCBDraft lifecycle event to built-in observability features."""
    from pcbdraft.interfaces.tui.observability import relay_shared_metrics
