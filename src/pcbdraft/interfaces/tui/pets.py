...
def _cmd_list(args) -> int:
    ...
    from pcbdraft.agent.pet.manifest import ManifestError, fetch_manifest
...
def _cmd_show(args) -> int:
    ...
    from pcbdraft.agent.pet import store
    from pcbdraft.agent.pet.constants import (
        DEFAULT_SCALE,
        LOOP_MS,
        STATE_ROWS,
        PetState,
    ...
    from pcbdraft.agent.pet.render import build_renderer
...
def _cmd_doctor(args) -> int:
    ...
    from pcbdraft.agent.pet import store
    from pcbdraft.agent.pet.render import detect_terminal_graphics, resolve_mode
...
def set_pet_scale(value: float | str) -> tuple[float, str | None]:
    ...
    """
    from pcbdraft.agent.pet.constants import clamp_scale
