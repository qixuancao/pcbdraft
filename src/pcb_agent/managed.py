...
MANAGED_SCHEMA = "pcb-agent-managed-project"
MANAGED_VERSION = 1
MANAGED_MANIFEST = "project.pcb-agent.json"
...
def materialize_managed_design(
    ...
    *,
    ...
    with ResourceLock(target, parent / ".pcb-agent-locks", timeout=lock_timeout):
        ...
        try:
            ...
            manifest = {
                ...
                "sync": {
                    ...
                    "state": "synchronized",
                    "kicad_compatibility": pcb.kicad_version,
                },
            }
